...
class HorizontalCarousel extends Component {
    ...
    componentWillMount() {
        ...
        this.setState({
            current_img_width_as_percentage: img_width_as_percentage,
        });
    }

    componentDidMount() {
        this.view_port.style.width = `${this.state.current_img_width_as_percentage}vw`;
        const img_width_in_pixels = this.card_container.children[0].getBoundingClientRect()
            .width;
        ...
        window.addEventListener("resize", () => {
            const img_width_as_percentage =
                window.innerWidth < styles.media.min_width
                    ? 100
                    : (styles.media.max_img_size / window.screen.availWidth) *
                      100;
            ...
            this.setState({ current_card: new_current_card }, () => {
                ...
                if (this.state.current_card === 0) {
                    setTimeout(() => {
                        ...
                        this.card_container.style.transform = `translate(-${
                            img_width_in_pixels *
                            (this.card_container.children.length - 2)
                        }px)`;
                ...
                >
                    ...
                    >
                        <Card
                            ...
                            resize_width={
                                this.state.current_img_width_as_percentage
                            }
                        />
                        <Card
